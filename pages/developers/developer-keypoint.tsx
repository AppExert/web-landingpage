      ...
      >
        ...
        <g clipPath='url(#clip0_3427_102296)'>
          ...
          <g mask='url(#mask0_3427_102296)'>
            <path
              fillRule='evenodd'
              clipRule='evenodd'
              d='M305 225.537L225 145L145 225.537H223.934L145 305H305L226.066 225.537H305Z'
              fill='url(#paint0_linear_3427_102296)'
              fillOpacity='0.7'
            />
          </g>
        </g>
        <defs>
          ...
          >
            ...
            <feGaussianBlur
              stdDeviation='75'
              result='effect1_foregroundBlur_3427_102296'
            />
          </filter>
          <linearGradient
            id='paint0_linear_3427_102296'
            x1='225'
            y1='215'
            x2='264.5'
            y2='315.5'
      ...
      >
        ...
        <g clipPath='url(#clip0_3427_102288)'>
          ...
          <g mask='url(#mask0_3427_102288)'>
            <path
              fillRule='evenodd'
              clipRule='evenodd'
              d='M224.981 225C180.806 224.99 145 189.176 145 145H305C305 189.176 269.194 224.99 225.019 225C269.194 225.01 305 260.824 305 305H145C145 260.824 180.806 225.01 224.981 225Z'
              fill='url(#paint0_linear_3427_102288)'
              fillOpacity='0.7'
            />
          </g>
        </g>
        <defs>
          ...
          >
            ...
            <feGaussianBlur
              stdDeviation='75'
              result='effect1_foregroundBlur_3427_102288'
            />
          </filter>
          <linearGradient
            id='paint0_linear_3427_102288'
            x1='225'
            y1='215'
            x2='264.5'
            y2='315.5'
      ...
      >
        ...
        <g clipPath='url(#clip0_3427_102284)'>
          <path
            fillRule='evenodd'
            clipRule='evenodd'
            d='M185 224.5C207.091 224.5 225 206.591 225 184.5C225 206.591 242.909 224.5 265 224.5C242.909 224.5 225 242.409 225 264.5C225 242.409 207.091 224.5 185 224.5ZM185 224.5C162.909 224.5 145 242.409 145 264.5C145 286.591 162.909 304.5 185 304.5C207.091 304.5 225 286.591 225 264.5C225 286.591 242.909 304.5 265 304.5C287.091 304.5 305 286.591 305 264.5C305 242.409 287.091 224.5 265 224.5C287.091 224.5 305 206.591 305 184.5C305 162.409 287.091 144.5 265 144.5C242.909 144.5 225 162.409 225 184.5C225 162.409 207.091 144.5 185 144.5C162.909 144.5 145 162.409 145 184.5C145 206.591 162.909 224.5 185 224.5Z'
            fill='url(#paint0_linear_3427_102284)'
            fillOpacity='0.7'
          />
        </g>
        <defs>
          <filter
            id='filter0_f_3427_102284'
            x='0'
            y='0'
            width='450'
            height='450'
          ...
          >
            ...
            <feGaussianBlur
              stdDeviation='75'
              result='effect1_foregroundBlur_3427_102284'
            />
          </filter>
          <linearGradient
            id='paint0_linear_3427_102284'
            x1='225'
            y1='214.5'
            x2='264.5'
            y2='315'
      ...
      >
        ...
        <defs>
          ...
          >
            ...
            <feGaussianBlur
              stdDeviation='75'
              result='effect1_foregroundBlur_3427_102280'
            />
          </filter>
          <linearGradient
            id='paint0_linear_3427_102280'
            x1='225'
            y1='216.409'
            x2='255.208'
            y2='305.879'
      ...
      >
        ...
        <defs>
          ...
          >
            ...
            <feGaussianBlur
              stdDeviation='75'
              result='effect1_foregroundBlur_3427_102276'
            />
          </filter>
          <linearGradient
            id='paint0_linear_3427_102276'
            x1='225'
            y1='214.5'
            x2='271.113'
            y2='307.713'
      ...
      >
        ...
        <g clipPath='url(#clip0_3127_108589)'>
          <path
            fillRule='evenodd'
            clipRule='evenodd'
            d='M225 268.102C257.918 268.102 286.481 247.032 300.702 234.338C306.431 229.224 306.431 220.678 300.702 215.563C286.481 202.87 257.918 181.8 224.999 181.8C192.082 181.8 163.519 202.87 149.298 215.563C143.567 220.678 143.567 229.224 149.298 234.338C163.519 247.032 192.083 268.102 225 268.102ZM225 255.056C241.627 255.056 255.105 241.578 255.105 224.95C255.105 208.324 241.627 194.846 224.999 194.846C208.373 194.846 194.895 208.324 194.895 224.95C194.895 241.578 208.374 255.056 225 255.056Z'
            fill='url(#paint0_linear_3127_108589)'
            fillOpacity='0.7'
          />
        </g>
        <defs>
          <filter
            id='filter0_f_3127_108589'
            x='0'
            y='0'
            width='450'
            height='450'
          ...
          >
            ...
            <feGaussianBlur
              stdDeviation='75'
              result='effect1_foregroundBlur_3127_108589'
            />
          </filter>
          <linearGradient
            id='paint0_linear_3127_108589'
            x1='224.999'
            y1='219.557'
            x2='237.696'
            y2='279.447'
...
const DeveloperKeypoint = () => {
  return (
    <section className='md:py-[100px] md:mt-[0px] mt-[100px] '>
      {DEVELOPER_KEYPOINTS.map((item: any, index: number) => (
        <div
          className={
            index % 2 === 0
              ? "flex  md:gap-[140px] md:flex-row flex-col-reverse "
              : "flex  md:gap-[140px] md:flex-row-reverse flex-col-reverse "
          }
          key={index}
        >
