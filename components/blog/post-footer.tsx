    ...
    <div className='flex flex-col md:flex-row justify-between mt-2 mb-[100px]'>
      ...
      <div className='flex flex-row gap-[2px] mt-[16px] md:gap-[12px] md:mt-0'>
        <Button
          ...
          className={`page-btn-copy text-[16px] gap-2 w-max ${buttonText === "Copied" ? "border-solid border-2 border-[#1B1929] bg-transparent" : "page-btn-copy text-[16px] gap-2 w-max"}`}
        >
          <Image
            width={20}
            height={20}
