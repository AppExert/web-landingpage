...
const STARTUP_KEYPOINTS: {
    ...
    icon: (
      ...
      >
        <path
          fillRule='evenodd'
          clipRule='evenodd'
          d='M80 160C124.182 160 160 124.182 160 80C160 35.8176 124.182 0 80 0C35.8176 0 0 35.8176 0 80C0 124.182 35.8176 160 80 160ZM80 115C99.3296 115 115 99.3296 115 80C115 60.6704 99.3296 45 80 45C60.6704 45 45 60.6704 45 80C45 99.3296 60.6704 115 80 115Z'
          fill='url(#paint0_linear_367_2087)'
        />
        <defs>
          <linearGradient
            id='paint0_linear_367_2087'
            x1='80'
            y1='70'
            x2='119.5'
            y2='170.5'
...

  {
    ...
    icon: (
      ...
      >
        <path
          d='M140.458 129.542L100.914 90L140.458 50.4576L180 90L140.458 129.542ZM39.5424 129.542L0 90L39.5424 50.4576L79.0857 90L39.5424 129.542ZM90 180L50.4576 140.458L90 100.914L129.542 140.458L90 180ZM90 79.0857L50.4576 39.5424L90 0L129.542 39.5424L90 79.0857Z'
          fill='url(#paint0_linear_367_2097)'
          fillOpacity='0.7'
        />
        <defs>
          <linearGradient
            id='paint0_linear_367_2097'
            x1='90'
            y1='78.75'
            x2='134.437'
            y2='191.812'
    ...
    icon: (
      ...
      >
        <path
          ...
          fillRule='evenodd'
          clipRule='evenodd'
          d='M96 0H64V41.3728L34.7448 12.1176L12.1184 34.7448L41.3728 64H0V96H41.3728L12.1176 125.254L34.7456 147.882L64 118.627V160H96V118.627L125.255 147.882L147.882 125.255L118.627 96H160V64H118.627L147.882 34.7448L125.255 12.1176L96 41.3728V0Z'
          fill='url(#paint0_linear_367_2125)'
        />
        <defs>
          <linearGradient
            id='paint0_linear_367_2125'
            x1='80'
            y1='70'
            x2='119.5'
            y2='170.5'
  ...
  },
  {
    ...
    icon: (
      ...
      >
        <path
          d='M84.4488 0L5.13906 96.9341C1.72344 101.109 0.015632 103.196 0.000192813 104.956C-0.0132314 106.486 0.674947 107.939 1.86788 108.897C3.23987 110 5.93682 110 11.3307 110H74.4488L64.4488 180L143.759 83.0659C147.174 78.8912 148.882 76.8039 148.897 75.0439C148.911 73.5135 148.223 72.0613 147.03 71.1026C145.658 70 142.961 70 137.567 70H74.4488L84.4488 0Z'
          fill='url(#paint0_linear_367_2130)'
          fillOpacity='0.7'
        />
        <defs>
          <linearGradient
            id='paint0_linear_367_2130'
            x1='74.4488'
            y1='78.75'
            x2='125.045'
            y2='185.238'
