const CompanyTerms = () => {
  return (
    <div className=" flex flex-col justify-center items-center ">
      <div className="flex flex-col max-w-[800px]  md:gap-[48px] gap-[38px]  ">
        ...
        <div>
          <h2 className='sub-heading pb-[24px]'>Services</h2>
        ...
        <div>
          <h2 className='sub-heading pb-[24px]'>Client Access to Resources</h2>
        ...
        <div>
          <h2 className='sub-heading pb-[24px]'>Intellectual Property Rights</h2>
        ...
        <div>
          <h2 className='sub-heading pb-[24px]'>Confidentiality</h2>
        ...
        <div>
          <h2 className='sub-heading pb-[24px]'>Suspension of Services</h2>
